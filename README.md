# Engenharia_de_Prompt_e_Aplicacao
## Disciplina do curso de Ciencia da Computação
## Missão 01:
...
Trilhas Técnicas: Liste 3 áreas de foco (ex: NLP para análise de dados, Geração de Imagens para Marketing, Agentes Autônomos).
Critérios de Avaliação:
Originalidade: Quão inovadora é a solução?
Qualidade do Prompt: Uso de técnicas como Chain-of-Thought ou Few-Shot.
Impacto de Negócio: Valor gerado para o cliente final.
Sugestão de Stack Tecnológica: Quais modelos (GPT-4, Claude, Llama 3) e frameworks (LangChain, CrewAI) os participantes devem usar.
